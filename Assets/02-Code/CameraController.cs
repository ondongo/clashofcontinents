namespace ClashOfContinents
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        {
            if (_zooming == false && (UI_Main.instanse.isActive || UI_BuildingUpgrade.instanse.isActive == false && UI_Info.instanse.isActive == false))
            {
        ...
        {
            if (UI_Main.instanse.isActive && UI_BuildingUpgrade.instanse.isActive == false && UI_Info.instanse.isActive == false)
            {
                _moveRootBasePosition = _root.position;
